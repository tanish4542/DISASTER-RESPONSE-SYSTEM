...
class Emergency(Base):
    ...
    emergency_evidence_detected = Column(Boolean, nullable=True)
    operational_safety_processing = Column(Boolean, nullable=True)
    safety_protection_applied = Column(Boolean, nullable=True)
    final_priority_reason = Column(String, nullable=True)
